...
# starter_space_flights documentation build
...
from starter_space_flights import __version__ as release

# -- Project information -----------------------------------------------------

project = "starter_space_flights"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "starter_space_flightsdoc"
...
latex_documents = [
    (
        master_doc,
        "starter_space_flights.tex",
        "starter_space_flights Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "starter_space_flights",
        "Project starter_space_flights codebase.",
        "Data-Science",
    )
]
